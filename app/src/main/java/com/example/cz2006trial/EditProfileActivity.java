...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private boolean hasPhoto(ImageView imageView) {
        ...
        constantState = getResources()
                .getDrawable(R.drawable.ic_profile_pic, getTheme())
                .getConstantState();
    ...
    public void editPhoto(View editPhotoButton) {
        ...
        builder.setTitle("Add photo here");
        builder.setItems(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (items[item].equals("Take Photo")) {
                            ...
                            profilePhoto.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_profile_pic));
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                if (thumbnail != null) {
                    ...
                    Toast.makeText(getApplicationContext(), "Image capture error", Toast.LENGTH_SHORT).show();
                }
